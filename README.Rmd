...
One feature of [Visual Studio Code](https://code.visualstudio.com/)
is that it's lean and extensible. By default it comes with nothing of
...
Si venis de VS Code y una lengua distinta a R, entonces quizas no sepas exactamente que esperar de un IDE que soporte R. Esto resume lo que incluye [Positron](https://positron.posit.co/):
...
Una carasteristica de VS Code es que es ligero y extensible. Por
defecto no incluye nada de la lista de arriba [Visual Studio
